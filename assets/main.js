...
var transitionFunctions = {
  ...
  changeNavStyle: function changeNavStyle() {
  ...
  animateMain: function animateMain(items, type, interval) {
  ...
  styleHeaders: function styleHeaders(entries) {
    if (entries.length < 0) return;
    var targetItem = entries[0];
    ...
    if (targetItem.isIntersecting) {
      ...
      sibling.style.width = "".concat(target.getBoundingClientRect().width, "px");
  ...
  executeAnimation: function executeAnimation(entries) {
    var allTargets = [];
...
var observer = new IntersectionObserver(transitionFunctions.styleHeaders, {
  threshold: 1
});
var observerII = new IntersectionObserver(transitionFunctions.executeAnimation, {
  threshold: 0.5
});
/* event listeners */
...
DomElements.sectionHeadings.forEach(function (heading) {
  return observer.observe(heading);
});
DomElements.animateElements.forEach(function (element) {
  return observerII.observe(element);
});
...
DomElements.searchButton.addEventListener('click', function () {
  return transitionFunctions.animateMain([DomElements.searchArea], "popout", 200);
});
/* Closes the Search area */

DomElements.closeButton.addEventListener('click', function () {
  return DomElements.searchArea.classList.remove("popout");
});
}();
/******/ })()
;
